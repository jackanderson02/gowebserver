...
var userRepo, _ = initializeDatabase(config.LoadDatabaseConfig(".env.inmemory"))
var userService *service.UserService = service.NewUserService(userRepo)
var userAPI *api.UserAPI = api.NewUserAPI(userService)
...
func TestCreateUserWithServer(t *testing.T) {
	...
	server = httptest.NewServer(http.HandlerFunc(userAPI.CreateUser))
...
func TestDeleteUserWithServer(t *testing.T) {
	...
	server = httptest.NewServer(http.HandlerFunc(userAPI.DeleteUser))
	...
	server = httptest.NewServer(http.HandlerFunc(userAPI.GetSingleUser))
	defer server.Close()
...
func TestUpdateUserWithServer(t *testing.T) {
	...
	server = httptest.NewServer(http.HandlerFunc(userAPI.UpdateUser))
